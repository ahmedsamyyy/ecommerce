    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('indexcategory')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('createcategory')}}" data-i18n="nav.dash.crypto">أضافة
                             قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('indexsubcategory')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('createsubcategory')}}" data-i18n="nav.dash.crypto">أضافة
                            قسم فرعي جديد </a>
                    </li>
                </ul>
            </li>

            <li class="nav-item"><a href=""><i class="la la-male">{{\App\Models\Brand::count()}}</i>
            ...
            <li class="nav-item"><a href=""><i class="la la-male">{{\App\Models\Tag::count()}}</i>
        ...
        <li class="nav-item"><a href=""><i class="la la-male">{{\App\Models\Product::count()}}</i>
            <span class="menu-title" data-i18n="nav.dash.main">المنتجات</span>
            <span
                class="badge badge badge-success badge-pill float-right mr-2"></span>
        </a>
        <ul class="menu-content">
            <li class="active"><a class="menu-item" href="{{route('indexgeneral.products')}}"
                                  data-i18n="nav.dash.ecommerce"> عرض الكل </a>
            </li>
            <li><a class="menu-item" href="{{route('createproductsgeneral')}}" data-i18n="nav.dash.crypto">أضافة
                    منتجات  </a>
            </li>
        </ul>
    </li>
    <li class="nav-item"><a href=""><i class="la la-male">{{\App\Models\Attribute::count()}}</i>
        <span class="menu-title" data-i18n="nav.dash.main">خصائص</span>
        <span
            class="badge badge badge-success badge-pill float-right mr-2"></span>
    </a>
    <ul class="menu-content">
...
<li class="nav-item"><a href=""><i class="la la-male">{{\App\Models\Option::count()}}</i>
    <span class="menu-title" data-i18n="nav.dash.main">اوبشن</span>
    <span
        class="badge badge badge-success badge-pill float-right mr-2"></span>
</a>
<ul class="menu-content">
    ...
    <li><a class="menu-item" href="{{route('create.option')}}" data-i18n="nav.dash.crypto">أضافة
            خصائص  </a>
    </li>
</ul>
</li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                                                                                    data-i18n="nav.templates.main">Setttings</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل التوصيل</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('shippingmethod','local')}}">توصيل داخلي</a>
                            </li>
