                                                            ...
                                                            <td>
                                                                <div class="container"
                                                                    ...
                                                                    <a href="{{ route('editptoduct', $item->id) }}"
                                                                        ...
                                                                        <a href="{{ route('createprice', $item->id) }}"
                                                                            class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل السعر</a>
                                                                            <a href="{{ route('createstock', $item->id) }}"
                                                                                class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل الاستوك</a>
                                                                                <a href="{{ route('createphoto', $item->id) }}"
                                                                                    class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">الصورة</a>
